...
self.addEventListener('install', function (event) {
  event.waitUntil(
    caches.keys().then(function (names) {
      var validSets = ["is-sw-a5b2d3","is-html-a5b2d3","is-jsdelivr-a5b2d3","is-gtm-a5b2d3","is-gravatar-a5b2d3","is-theme-a5b2d3","is-cdn-a5b2d3","is-json-a5b2d3"];
      return Promise.all(
        names
